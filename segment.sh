...
JAVACMD="java -mx2g -cp $BASEDIR/seg.jar edu.stanford.nlp.ie.crf.CRFClassifier -sighanCorporaDict $DATADIR -sighanPostProcessing true -testFile $file -inputEncoding $enc $ARGS"
